...
class CB_SVDpp:
    ...
    def __init__(self, num_clusters:int, alpha:float, random_state = 123, n_epochs:int, verbose = False):
    ...
    def predictor_function(self, user_id, item_id):
    ...
    def predict_user(self, testset, user_id: int, item_id: int):
        ...
        try:
            ...
            for u, i, actual_rating in testset:
                ...
                try:
                    predicted_rating = self.predictor_function(self.algo.trainset.to_inner_uid(str(u)), 
    ...
    def predict_df(self, testset):
        ...
        for u, i, actual_rating in testset:
            try:
                ...
                predicted_rating = self.predictor_function(inner_user_id, inner_item_id)
                predictions.append(predicted_rating)
